...
class SwipeableOpenContainer extends StatefulWidget {
  ...
  @override
  _OpenContainerState2 createState() => _OpenContainerState2();
}

class _OpenContainerState2 extends State<SwipeableOpenContainer> {
...
class _OpenContainerRoute extends ModalRoute<void> {
  ...
  Widget buildTransitions(BuildContext context, Animation<double> animation,
    ...
    return OpenContainerBackGestureDetector<dynamic>(
      child: child,
      enabledCallback: () => true, //_isPopGestureEnabled<T>(route),
      onStartPopGesture: () {
...
class OpenContainerBackGestureDetector<T> extends StatefulWidget {
  const OpenContainerBackGestureDetector({
    Key key,
...
class _OpenContainerBackGestureDetectorState<T>
    extends State<OpenContainerBackGestureDetector<T>> {
...
class _OpenContainerBackGestureController<T> {
  ...
  void dragUpdate(double delta) {
    ...
    controller.value = newValue.clamp(0, 1).toDouble();
  }
